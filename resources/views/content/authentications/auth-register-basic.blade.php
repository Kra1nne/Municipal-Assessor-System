    ...
    <div class="authentication-inner py-6 mx-4">
      ...
      <div class="card p3">
        ...
        <div class="card-body mt-1">
          ...
          <form class="mb-5" id="AddAccountData">
            @csrf
            <div class="form-floating form-floating-outline mb-5">
              <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Enter your username" autofocus>
              <label for="firstname">Firstname</label>
            </div>
             <div class="form-floating form-floating-outline mb-5">
              <input type="text" class="form-control" id="middlename" name="middlename" placeholder="Enter your username" autofocus>
              <label for="middlename">Middlename</label>
            </div>
             <div class="form-floating form-floating-outline mb-5">
              <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Enter your username" autofocus>
          ...
          <button class="btn btn-primary d-grid w-100 mb-5" id="AddAcountBtn">
              Sign up
            </button>
